...
namespace PSA012_UpdateExistingProject
{
    ...
    public class UpdateExistingProject
    {
        ...
        [TestMethod]
        public void TC05_02_UpdateExistingProject()
        {
            using (xrmApp)
            {
                ...
                xrmApp.Grid.SwitchView("My Active Projects");
                xrmApp.ThinkTime(5000);
                ...
                xrmApp.Entity.SetValue("msdyn_subject", "Project Updated " + rndProjectName);
                xrmApp.ThinkTime(5000);
