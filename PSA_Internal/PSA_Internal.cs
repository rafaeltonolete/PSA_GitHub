    ...
    public class PSA_Internal
    {
        ...
        public void TC05_BulkCopyAndCreateTimeEntries()
        {
            ...
            using (xrmApp)
            {
                ...
                //input[@aria-label='Starting on'][contains(@data-id,'toDate')]
        ...
        /*Given there are Time Entries Submitted*/
        ...
        /*Given that a Task record exist*/
        [TestMethod]
        ...
        public void TC07_UpdateEmail()
        {
            ...
            using (xrmApp)
            {
                ...
                //Enter new Subject
                client.Browser.Driver.FindElement(By.XPath(".//input[contains(@aria-label,'Subject')]")).Clear();
                client.Browser.Driver.FindElement(By.XPath(".//input[contains(@aria-label,'Subject')]")).SendKeys(Keys.Backspace);
                client.Browser.Driver.FindElement(By.XPath(".//input[contains(@aria-label,'Subject')]")).SendKeys(Keys.Backspace);
                client.Browser.Driver.FindElement(By.XPath(".//input[contains(@aria-label,'Subject')]")).SendKeys(Keys.Backspace);
        ...
        public void TC08_UpdateAppointment()
        {
            ...
            using (xrmApp)
            {
                ...
                client.Browser.Driver.FindElement(By.XPath(".//input[@aria-label='Subject']")).Hover(client.Browser.Driver);
                ...
                client.Browser.Driver.FindElement(By.XPath(".//textarea[@aria-label='Description']")).Hover(client.Browser.Driver);
